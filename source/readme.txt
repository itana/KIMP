...
IMPORTANT: Because of the system wide nature of function hooking, it is
very hard to make the memory profiler to be "bug free" in all situation.
Therefore, remember to make sure the profiler is not enabled in your final
release build, just use it when you need to profile.
